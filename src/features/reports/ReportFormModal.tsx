...
import type { AdminUserRow, ReportType } from "@/lib/laravel-api";
import { adminListUsers } from "@/lib/laravel-api";
...
export function ReportFormModal(props: {
  ...
  useEffect(() => {
    ...
    if (props.mode === "create" && props.fixedUser?.id) {
      ...
      // ajuda: se vier vazio, sugere o nome da conta como ponto de partida
  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {props.mode === "create" ? "Novo Relatório" : "Editar Relatório"}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form.type}
                onValueChange={(v) => setForm((p) => ({ ...p, type: v as ReportType }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Escreva o conteúdo completo do relatório. Use parágrafos para melhor formatação."
            />
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button onClick={handleSubmit} disabled={!canSubmit || saving}>
              {saving ? "Salvando..." : props.mode === "create" ? "Criar e Enviar" : "Salvar Alterações"}
            </Button>
          </div>
        </div>
      </DialogContent>
