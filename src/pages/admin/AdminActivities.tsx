...
import { Activity, Plus, Search, FileText, Clock, Tag, Grid3X3, ChevronDown, Ear, Type, CircleDot, Layers, Share2, Image } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                ...
                <DropdownMenuItem onSelect={() => navigate("/admin/jogos/roleta/novo")}>
                ...
                <DropdownMenuItem onSelect={() => navigate("/admin/jogos/acerte-imagem/novo")}>
