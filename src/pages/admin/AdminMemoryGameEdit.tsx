      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-6">
          <h1 className="text-2xl lg:text-3xl font-display font-bold text-foreground inline-flex items-center gap-2">
            ...
            Editar Jogo da Memória
          </h1>
          {game && (
            <p className="text-muted-foreground">Pares: {game.pairs_count} • ID: {game.id}</p>
          )}
        </div>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Se você selecionar imagens aqui, envie exatamente <b>{game?.pairs_count ?? 0}</b> (1 por par) para substituir.
                  </div>
                  <input
                    id="pair-images"
                    type="file"
                  ...
                  <Button asChild variant="secondary">
                    <label htmlFor="pair-images" className="cursor-pointer inline-flex items-center">
                  ...
                  {pairImages.length > 0 && (
                    <div className="text-sm text-muted-foreground">
                      {pairImages.length} arquivo(s) selecionado(s)
                    </div>
                  )}
                </div>
              </div>
