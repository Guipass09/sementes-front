...
export default function AdminWordSearchGames() {
  ...
  const [shareTarget, setShareTarget] = useState<WordSearchGameRow | null>(null);
  ...
  const refresh = async () => {
    ...
    try {
      const [res, u] = await Promise.all([
        isProfessional ? api.professionalListWordSearchGames() : api.adminListWordSearchGames(),
  ...
  const confirmDelete = async () => {
    ...
    try {
      await (isProfessional ? api.professionalDeleteWordSearchGame(deleteTarget.id) : api.adminDeleteWordSearchGame(deleteTarget.id));
    ...
    <div className="min-h-full py-8 lg:py-12">
      <div className="container mx-auto px-4">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Button onClick={() => navigate(`${base}/jogos/caca-palavras/novo`)} className="w-full sm:w-auto">
                        ...
                        {list.map((g) => (
                          ...
                          >
                            ...
                            <div className="flex flex-wrap gap-2 justify-end">
                              ...
                              <Button
                                variant="outline"
                                onClick={() => navigate(`${base}/jogos/caca-palavras/${g.id}/editar`)}
